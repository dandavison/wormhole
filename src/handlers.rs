...
pub fn open_project_in_vscode(path: &str) -> Result<bool, String> {
...
pub fn open_path_in_vscode(path: &str) -> Result<bool, String> {
...
pub fn open_github_url_in_vscode(url: &str) -> Result<bool, String> {
